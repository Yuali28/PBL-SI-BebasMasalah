...
$config = [
    ...
    'data' => [
        [1, 'K294750385', 'Setia Budi Pratama', 'Elektro', 'Teknik Informatika', '2020', 'Bermasalah', 'Bermasalah', 'Bermasalah', 'Bermasalah'],
        [2, 'L058365938', 'Bulan Biru', 'Elektro', 'Teknik Informatika', '2020', 'Bebas Masalah', 'Bermasalah', 'Bermasalah', 'Bermasalah'],
        [3, 'A918295648', 'Jaya Agung', 'Elektro', 'Teknik Informatika', '2020', 'Bebas Masalah', 'Bermasalah', 'Bermasalah', 'Bermasalah'],
    ],
    // 'order '
    // 'order' => [[1, 'asc']],
    // ini gasan
